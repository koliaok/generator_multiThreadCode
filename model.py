...
class Model():
    ...
    def sample(self, sess, chars, vocab, tensor,num=500 ,sampling_type=1):## 학습된 모델에서 단어를 생성하는 부분
        ...
        for n in range(num):
            ...
            if sentence_end_token == pred or sentence_start_token == pred:
                ret+='\n'
            else:
                ret += pred
                ret +=" "
